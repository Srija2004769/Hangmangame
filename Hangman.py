"""a hangman game in which the objective of the player is to find the hidden word ,every incorrect guess
 leads to the decrement in the chances left for the player """
...
if __name__ == "__main__":
    ...
    clear()
    topics = {1: "Languages", 2:"Countries", 3:"Currencies"}
 
    dataset = {"Languages":["ENGLISH", "HINDI", "SPANISH", "RUSSIAN", "KOREA", "CHINESE", "ARABIC", "GREEK", "GERMAN"],\
                 "Countries":["INDIA", "RUSSIA", "QUWAIT", "AUSTRALIA", "AMERICA", "GREEN LAND"],
                 "currencies":["RUPEE", "DOLLAR", "EUROS", "RUBLE"]
                 }
    while True:
